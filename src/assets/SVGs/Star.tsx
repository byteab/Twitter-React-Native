...
function SvgComponent(props: SvgProps) {
  return (
    <Svg
      viewBox="0 0 24 24"
      aria-hidden="true"
      className="prefix__r-18jsvk2 prefix__r-4qtqp9 prefix__r-yyyyoo prefix__r-179l7hd prefix__r-dnmrzs prefix__r-bnwqim prefix__r-1plcrui prefix__r-lrvibr prefix__r-10uooop"
      {...props}>
